      ...
      <main className={styles.main}>
        <section className={styles.header}>
          <div className={styles.headerWrapper}>
            <div className={styles.headerText}>
              <Headlines tag='h1'>{data && data.attributes.title}</Headlines>
            ...
            <div className={styles.headerSocial}>
              <div className={styles.headerSocialWrapper}>
                ...
                <div className={styles.headerSocialTime}>
                  ...
                  <span>
                    {data && data.attributes.time_work}
                  </span>
                </div>
              </div>
            </div>
        ...
        <section className={styles.service}>
          <div className={styles.serviceWrapper}>
            <div className={styles.serviceTitle}>
              <Headlines tag='h2'>
                {data && data.attributes.title_services}
              </Headlines>
            </div>
        ...
        <section className={styles.approach}>
          ...
          <div className={styles.approachList}>
            <Headlines tag='h2'>Наш подход</Headlines>
            <ul className={styles.approachListItems}>
              {data && approach.map((item, key) => (
        ...
        <section className={styles.slogan}>
          <div className={styles.sloganWrapper}>
            <Headlines tag='h4'>Каждый проект мы рассматриваем как уникальный продукт, который будет работать для людей. <br />
              Бренд, который с каждым днём становится сильнее.</Headlines>
          </div>
        </section>
        <section className={styles.cases}>
          <div className={styles.casesTitle}>
...
export const getStaticProps = async () => {
  const { data: page } = await axios.get<HomeProps>(process.env.NEXT_PUBLIC_DOMAIN + '/api/main-page?populate=*');
  return {
    props: {
      page
    }
